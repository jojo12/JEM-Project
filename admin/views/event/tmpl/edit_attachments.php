...
<table class="adminform" id="el-attachments">
    <tbody>
    <?php foreach ($this->item->attachments as $i => $file): ?>
        <tr class="jem-attachment-row jem-attachment-existing-row">
            <td>
                <div>
                    <div class="title"><?php echo Text::_('COM_JEM_ATTACHMENT_FILE');?></div>
                    <input class="form-control readonly valid form-control-success w-75" type="text" readonly="readonly" value="<?php echo $this->escape($file->file); ?>">
    ...
    <tr class="jem-attachment-row jem-attachment-upload-row jem-attachment-template-row d-none" aria-hidden="true" hidden>
        <td style="width:100%">
            <div style="display: inline-block; text-wrap: none;">
                ...
                <input type="hidden" name="attach-order[]" class="attachment-order" value="<?php echo count($this->item->attachments); ?>" disabled="disabled">
